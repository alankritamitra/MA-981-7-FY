...
#dropping the country which have large number of missing values
...
def arima(data):
    # Assuming you have a NumPy array called 'data' with your time series values
    data_array = np.array(data)
...
def sarima(data):# Assuming you have a NumPy array called 'data' with your time series values
    data_array = np.array(data)
...
# Set the ARIMA order (p, d, q)
p, d, q = 2, 0, 2  # Replace with your chosen values# Split the data into training and testing sets
...
average_mse = sqrt(mse_df['MSE'].mean())
